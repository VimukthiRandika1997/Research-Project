...
def run_experiment(experiment_name, model, train_loader, val_loader, test_loader, epochs, edge_feature_compact=True):
    ...
    trained_model, \
        ...
        train_loss_list, \
        val_acc_list, \
        val_loss_list = train(model, train_loader,
                              val_loader, epochs, edge_feature_compact)
